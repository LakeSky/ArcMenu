...
public class ArcFlexibleLayout extends ViewGroup {
    /**
    ...
    public ArcFlexibleLayout(Context context) {
        super(context);
    }

    public ArcFlexibleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            StarView view = (StarView) getChildAt(i);
            int radius = mExpanded ? view.getRadius() : 0;
            Rect frame = computeChildFrame(centerX, centerY, radius, view.getDegree(), mChildSize);
