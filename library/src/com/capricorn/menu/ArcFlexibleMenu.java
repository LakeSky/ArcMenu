...
import com.capricorn.ArcFlexibleLayout;
...
public class ArcFlexibleMenu  extends RelativeLayout {
    ...
    public ArcFlexibleMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        applyAttrs(attrs);
    }
    ...
    private void init(Context context) {
        ...
        mArcLayout = (ArcFlexibleLayout) findViewById(R.id.item_layout);
